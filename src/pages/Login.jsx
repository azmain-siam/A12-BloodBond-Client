  ...
  return (
    <div className="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg  lg:max-w-5xl mt-6 mb-10 border">
      ...
      <div className="w-full px-6 py-8 md:px-8 lg:w-1/2">
        ...
        <button className="flex w-full items-center justify-center mt-4  transition-colors duration-300 transform border rounded-lg   hover:bg-gray-50 hover:border-primary">
